  ...
  renderZainInvoiceTemplate: function(inv, pLang, settings, fmt, qrSvgHtml, logoHtml, arTafqeet, enTafqeet) {
    ...
    printEl.innerHTML = `
      <div class="zain-inv-container">
        ...
        <!-- 4. Items Table (11 Columns) with Continuous Vertical Column Lines -->
        <div class="zain-table-container">
          <img src="${settings.logoUrl || 'assets/zain_logo.svg'}" class="zain-table-watermark" alt="Watermark">
