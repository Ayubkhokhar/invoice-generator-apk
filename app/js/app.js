      ...
      <div class="zain-inv-container">
        ...
        <div class="zain-sub-header">
          <div class="zain-sub-left">
            <span>Page 1 of 1</span> &nbsp;&nbsp; <span dir="rtl">${inv.pageInfo || 'رقم الصفحة : 1'}</span>
          </div>
          <div class="zain-sub-center">
            ${docTitle}
          </div>
          <div class="zain-sub-right">
            <span>C.R No. : <b>${settings.crNumber || '4030294347'}</b> <span dir="rtl">: رقم س ت</span></span><br>
            <span>VAT No. : <b>${settings.taxNumber || '311186943400003'}</b> <span dir="rtl">: الرقم الضريبي</span></span>
          </div>
        </div>
        ...
        <div class="zain-meta-section">
          ...
          <div class="zain-customer-bar">
            ...
            <div dir="rtl"><span style="color:#9e0e24; font-size:10.5px; font-weight:900;">${custName}</span> : اسم العميل</div>
          </div>
